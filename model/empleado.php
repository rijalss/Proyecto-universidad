...
class empleado extends Conexion{
	...
	function incluir(){
		...
		if(!$this->existe($this->cedula)){
			...
			try {
					...
					$p->bindParam(':cedulaEmpleado',$this->cedula);		
					$p->bindParam(':apellidoEmpleado',$this->apellido);
					$p->bindParam(':nombreEmpleado',$this->nombre);	
                    $p->bindParam(':correoEmpleado',$this->correo);
					$p->bindParam(':telefonoEmpleado',$this->telefono);
                    $p->bindParam(':contraseña',$this->contraseña);
	...
	private function existe($cedula){
		...
		try{
			...
			$resultado = $co->query("Select * from empleados where cedulaEmpleado='$cedula'");
	...
	function consultatr(){
		...
		try{
			...
			$resultado = $co->query("Select * from emplados where cedulaEmpleado='$this->cedula'");
			$fila = $resultado->fetchAll(PDO::FETCH_BOTH);
			if($fila){
